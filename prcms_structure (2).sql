...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2021 at 02:04 PM
...
CREATE TABLE `employee` (
  ...
  `email` varchar(255) NOT NULL,
  `photo` varchar(255) DEFAULT 'v1611138371/employees/vishal2_gowht7.png',
...
CREATE TABLE `roles` (
  ...
  `roleColor` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `purpose`
  MODIFY `purp_id` int(11) NOT NULL AUTO_INCREMENT;
